...
🚀 **[View the Live Application on GitHub Pages](https://chubarevgeniy.github.io/Nutrition-analysis-/)** *(Make sure to enable GitHub pages in your repo settings -> Pages -> Build and deployment: GitHub Actions)*
